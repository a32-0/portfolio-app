...
export const connectLiverpool: CaseStudy = {
  ...
  metrics: [
    ...
    { value: 'Staging', label: 'Current status', delta: 'Pre-production QA phase' },
  ],
  sections: [
    {
      id: 'context',
    ...
    },
    {
      ...
      body: [
        'Before touching the design, I needed to understand the operation. Not from documentation, but from observation. I combined three research inputs to build that understanding.',
      ],
      subsections: [
        {
    ...
    },
    {
      ...
      body: [
        'Connect is currently in staging, in the pre-production final QA phase. What exists at this point is a validated high-fidelity prototype, a structured development build approaching production readiness, and a stakeholder group that has reviewed and endorsed the design direction.',
      ],
      subsections: [
        {
