...
export const whatsappLiverpool: CaseStudy = {
  ...
  subtitle: "A channel built by operations, for operations. What happened when a designer started asking the right questions inside it.",
  client: 'El Puerto de Liverpool',
  period: 'Jan 2026 – Present',
  disciplines: ['Conversational UX', 'Product Design', 'UX Research'],
  overview:
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "That's where this is going. And it's where I want to keep building.",
      ],
    },
  ],
  footnote:
