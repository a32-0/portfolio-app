...
export default function About() {
  return (
    <section className="inline-flex w-full flex-col items-start justify-start gap-4 tracking-tight pb-50">
      <p className="text-3xl font-normal font-serif italic text-primary">{aboutSection.eyebrow}</p>
      <div className="self-stretch text-4xl font-normal font-sans text-black">
